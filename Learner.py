...
from model import Backbone, Arcface, MobileFaceNet, Am_softmax, l2_norm,shufflenet#,ShuffleNetV2
import model
...
#             self.scheduler = optim.lr_scheduler.ReduceLROnPlateau(self.optimizer, patience=40, verbose=True)
            ...
            self.agedb_30, self.cfp_fp, self.lfw, self.agedb_30_issame, self.cfp_fp_issame, self.lfw_issame = get_val_data('/root/NewDisk/daxing2/WW/data/faces_vgg_112x112/')#self.loader.dataset.root.parent
        else:
