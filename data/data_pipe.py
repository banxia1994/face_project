...
def get_train_loader(conf):
    ...
    if conf.data_mode == 'vgg':
        ...
        ds, class_num = get_train_dataset('/root/NewDisk/daxing2/WW/data/faces_vgg_112x112''/imgs')#conf.emore_folder/
    elif conf.data_mode == 'caisa':
        ds, class_num = get_train_dataset('/root/NewDisk/daxing2/CAISAdataset_23/')
